<?php $__env->startSection('title', 'Gestor de Centros'); ?>
            ...
            <div class="p-6">
                <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex flex-wrap gap-3">
                        <button type="button" class="inline-flex items-center px-4 py-2.5 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 shadow-md transition-colors font-medium text-sm" onclick="window.location.href='<?php echo e(route('centros.bodegas.index')); ?>'">
                    ...
                    <div class="inline-flex items-center px-4 py-2 bg-slate-100 rounded-lg">
                        ...
                        <span class="ml-2 font-bold text-gray-800"><?php echo e($centros->count()); ?></span>
                    </div>
                </div>
                            ...
                            <div class="flex items-center justify-between gap-4">
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="min-w-0">
                                            <h3 class="text-lg font-bold text-gray-900 truncate"><?php echo e($centro->name_centro); ?></h3>
                                            <p class="text-xs text-gray-500 mt-0.5">
                                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-700">
                                                    <i class="fas fa-layer-group mr-1"></i><?php echo e($centro->subcentros->count()); ?> subcentros
                                                </span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-center gap-2 flex-shrink-0">
                                    <button type="button" class="p-2 text-yellow-600 hover:bg-yellow-50 rounded-lg transition-colors" title="Editar centro" onclick="openCentroModal(<?php echo e($centro->id); ?>, '<?php echo e(addslashes($centro->name_centro)); ?>')">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <form action="<?php echo e(route('centros.destroy', $centro->id)); ?>" method="POST" onsubmit="return confirm('Eliminar centro y sus subcentros?')">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <button type="button" class="px-3 py-2 bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors text-sm font-medium" onclick="toggleSubs(event,'subs-<?php echo e($centro->id); ?>')" aria-expanded="false">
...
<div class="p-5">
                            <div class="bg-slate-50 rounded-xl p-4 border border-slate-200">
                                <h4 class="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
                                    ...
                                    ?>
                                    <form action="<?php echo e(route('centros.subcentros.store', $centro->id)); ?>" method="POST" class="add-sub-form" data-centro-id="<?php echo e($centro->id); ?>">
                                        <?php echo csrf_field(); ?>
                                        <?php
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                            ...
                                            <div class="sm:col-span-2 relative">
                                                ...
                                                <input type="search" class="w-full px-3 py-2.5 border border-slate-300 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-sm" placeholder="Buscar subcentro..." autocomplete="off" data-subs='<?php echo json_encode($subs_for_input, 15, 512) ?>'>
                                  ...
                                  <div id="subs-<?php echo e($centro->id); ?>" class="mt-4 hidden rounded-xl border border-slate-200 overflow-hidden">
                                      <div class="bg-slate-100 px-4 py-2 border-b border-slate-200 flex items-center justify-between">
                                          ...
                                          <span class="text-xs text-gray-500"><?php echo e($centro->subcentros->count()); ?> registros</span>
                                      </div>
                                      <div class="max-h-64 overflow-auto thin-scrollbar">
                                          ...
                                          <?php $__empty_1 = true; $__currentLoopData = $centro->subcentros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                              <tr class="hover:bg-slate-50 transition-colors">
                                                  <td class="px-4 py-3 text-gray-800">
                                                      <div class="flex items-center gap-2">
                                                          <i class="fas fa-folder text-gray-400"></i>
                                                          <span><?php echo e($sub->name_subcentro); ?></span>
                                                      </div>
                                                  </td>
                                                  <td class="px-4 py-3 text-right">
                                                      <form action="<?php echo e(route('centros.subcentros.destroy', $sub->id)); ?>" method="POST" class="inline-block" data-confirm="Quitar asociación de este subcentro?">
                                                          <?php echo csrf_field(); ?>
                                                          <?php echo method_field('DELETE'); ?>
...
<div id="addCentroModal" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center z-50 px-4">
    <div class="bg-white rounded-2xl shadow-2xl border border-slate-200 ring-1 ring-slate-100 w-full max-w-lg max-h-[80vh] overflow-auto mx-auto">
        ...
        <div class="p-4">
            <form id="centroForm" action="<?php echo e(route('centros.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <div class="mb-3 grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                <div>
                    ...
                    <select id="modalCentroSelect" class="w-full px-3 py-2 border rounded">
                        ...
                        <?php $__currentLoopData = $centros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cc->id); ?>"><?php echo e($cc->name_centro); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
            ...
            <div class="mb-3">
                ...
                <div id="modalSubList" class="border rounded max-h-48 overflow-auto p-2 thin-scrollbar">
                    ...
                    <table class="min-w-full text-sm">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $allSubcentrosList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="odd:bg-white even:bg-gray-50">
                                <td class="px-2 py-1"><?php echo e($s->name_subcentro); ?></td>
                                <td class="px-2 py-1"><?php echo e(optional($s->centro)->name_centro ?? '—'); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<script>
    const BASE_CENTROS_URL = '<?php echo e(url('/centros')); ?>';
    ...
    function openCentroModal(id, name){
        ...
        if (id) {
            ...
            idInput.value = '';
            nameInput.value = '';
            form.action = '<?php echo e(route('centros.store')); ?>';
...
<script>
 document.addEventListener('DOMContentLoaded', function(){
        <?php if(session('success')): ?>
            Swal.fire({ icon: 'success', title: 'Listo', text: <?php echo json_encode(session('success')); ?> });
        <?php endif; ?>
        <?php if(session('error')): ?>
            Swal.fire({ icon: 'error', title: 'Error', text: <?php echo json_encode(session('error')); ?> });
        <?php endif; ?>
    });
</script>
<?php endif; ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Requisicion\resources\views/centros/gestor.blade.php ENDPATH**/ ?>