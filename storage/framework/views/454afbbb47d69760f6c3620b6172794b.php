...
<div class="container mx-auto px-4 py-8 max-w-7xl">
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <?php elseif(isset($subcentroActual) && $subcentroActual): ?>
        ...
        <div class="flex items-center gap-3">
            <?php if(!$mostrarResumen): ?>
                ...
                <a href="<?php echo e(route('inventario.plantilla', ['subcentro_id' => $subcentroActual->id])); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg">
                    <i class="fas fa-download mr-1"></i> Descargar Plantilla
                </a>
                <button onclick="abrirModalImportar(<?php echo e($subcentroActual->id); ?>)" class="bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-4 rounded-lg">
    ...
    <div class="space-y-6">
        <?php $__empty_1 = true; $__currentLoopData = $todasLasBodegas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bodega): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-lg font-bold"><?php echo e($bodega['nombre']); ?></h2>
                            <p class="text-blue-100 text-sm">Total: <?php echo e($bodega['totalUnidades']); ?> unidades en <?php echo e($bodega['totalProductos']); ?> productos</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                <?php if(count($bodega['operaciones']) > 0): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php $__currentLoopData = $bodega['operaciones']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('inventario.index', ['subcentro' => $operacion['id']])); ?>" 
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="inline-block px-3 py-1 rounded-full text-sm font-bold bg-blue-100 text-blue-800">
                                    <?php echo e($operacion['cantidadProductos']); ?>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="inline-block px-3 py-1 rounded-full text-sm font-bold bg-green-100 text-green-800">
                                    <?php echo e($operacion['cantidadUnidades']); ?>
    ...
    <div class="bg-white rounded-lg shadow p-4 mb-6">
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-2 flex-1">
                ...
                <?php if($isVerTodas && $subcentroSeleccionado): ?>
                <a href="<?php echo e(route('inventario.index')); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-2 px-4 rounded-lg text-sm">
...
function crearModalImportar() {
    ...
    document.getElementById('form-importar').addEventListener('submit', async function(e) {
        ...
        try {
            var res = await fetch('<?php echo e(route("inventario.importar")); ?>', {
                method: 'POST',
