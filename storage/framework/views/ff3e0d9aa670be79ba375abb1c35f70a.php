    ...
    <div class="max-w-7xl mx-auto mt-6 bg-white/95 rounded-2xl shadow-2xl border border-slate-200 ring-1 ring-slate-100 overflow-hidden">
                ...
                <div class="flex flex-col md:flex-row gap-2 md:items-center">
                    ...
                    <select id="filterProveedor" onchange="filterTable()"
                        ...
                        <?php $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($prov->prov_name); ?>"><?php echo e($prov->prov_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="border-b hover:bg-gray-50">
                                <td class="px-4 py-2" data-col="sku"><?php echo e($producto->sku ?? $producto->id); ?></td>
                                <td class="px-4 py-2" data-col="nombre"><?php echo e($producto->name_produc); ?></td>
                                <td class="px-4 py-2" data-col="categoria"><?php echo e($producto->categoria_produc); ?></td>
                                <td class="px-4 py-2" data-col="proveedor">
                                    <?php if($provList && $provList->count()): ?>
                                        <ul class="text-sm">
                                            <?php $__currentLoopData = $provList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li><?php echo e($pv->prov_name); ?> <small class="text-gray-500">($<?php echo number_format($pv->price_produc,2); ?> <?php echo e($pv->moneda ?? ''); ?>)</small></li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                    <?php else: ?>
                                        N/A
                                ...
                                <td class="px-4 py-2"><?php echo e(number_format($producto->stock_produc, 0)); ?></td>
                                <td class="px-4 py-2"><?php echo e($producto->unit_produc); ?></td>
                                <td class="px-4 py-2"><?php echo e(isset($producto->iva) ? number_format($producto->iva, 2).'%' : '-'); ?></td>
                                ...
                                <td class="px-4 py-2 text-center">
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        ?>
                                        <button
                                            data-providers='<?php echo json_encode($provList, 15, 512) ?>'
                                            onclick="openEditModal(this, <?php echo e($producto->id); ?>, '<?php echo e(addslashes($producto->name_produc)); ?>', '<?php echo e(addslashes($producto->categoria_produc)); ?>', <?php echo e($producto->stock_produc); ?>, <?php echo e($editPrice); ?>, <?php echo e($producto->iva ?? 0); ?>, '<?php echo e(addslashes($producto->unit_produc)); ?>', `<?php echo e(addslashes($producto->description_produc)); ?>`)"
                                        ...
                                        <button
                                            data-providers='<?php echo json_encode($provList, 15, 512) ?>'
                                            data-product-name="<?php echo e(addslashes($producto->name_produc)); ?>"
                                            onclick="openManageProvidersModal(this, <?php echo e($producto->id); ?>)"
                                            class="text-yellow-600 hover:text-yellow-800" title="Gestionar Proveedores">
                                            <i class="fas fa-boxes"></i>
                                        </button>
                                        <form action="<?php echo e(route('productos.destroy', [$producto->id], false)); ?>" method="POST"
        ...
        <div id="solicitudes-section" class="p-4 overflow-x-auto hidden thin-scrollbar">
            ...
            <table id="solicitudesTable" class="w-full table-auto">
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        <td class="px-4 py-2"><?php echo e($solicitud->created_at ? $solicitud->created_at->format('d/m/Y') : ''); ?></td>
                        <td class="px-4 py-2"><?php echo e($solicitud->name_user); ?></td>
                        <td class="px-4 py-2"><?php echo e($solicitud->nombre); ?></td>
                        <td class="px-4 py-2"><?php echo e($solicitud->descripcion); ?></td>
                        <td class="px-4 py-2 text-center">
                            <div class="flex justify-center space-x-2">
                                <?php if($solicitud->trashed()): ?>
                                <form action="<?php echo e(route('nuevo_producto.restore', [$solicitud->id], false)); ?>" method="POST"
                                ...
                                <form action="<?php echo e(route('nuevo_producto.forceDelete', [$solicitud->id], false)); ?>" method="POST"
                                ...
                                <button type="button" onclick="openAddFromSolicitudModal(<?php echo e($solicitud->id); ?>)"
                                    class="text-green-600 hover:text-green-800" title="Añadir producto">
                                    <i class="fas fa-plus"></i>
                                </button>

                                <!-- Botón Rechazar solicitud (icono minimalista) -->
                                <form action="<?php echo e(route('nuevo_producto.destroy', [$solicitud->id], false)); ?>" method="POST"
                                ...
                                <button type="button"
                                    onclick="openSolicitudModal('<?php echo e($solicitud->nombre); ?>', `<?php echo e($solicitud->descripcion); ?>`, '<?php echo e($solicitud->name_user); ?>')"
        ...
        <div id="productModal"
            ...
            <div class="bg-white rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-1/2 max-h-screen overflow-y-auto">
                ...
                <div class="p-4">
                    <form id="productForm" action="<?php echo e(route('productos.store', [], false)); ?>" method="POST"
                            ...
                            <div class="relative mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <div id="categoria_dropdown"
                                        ...
                                        <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="px-3 py-2 hover:bg-indigo-100 cursor-pointer option-item-cat" data-value="<?php echo e($cat); ?>"><?php echo e($cat); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <div id="unit_dropdown"
                                        ...
                                        <?php $__currentLoopData = $unidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="px-3 py-2 hover:bg-indigo-100 cursor-pointer option-item-cat" data-value="<?php echo e($uni); ?>"><?php echo e($uni); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
        ...
        <div id="proveedorModal"
            ...
            <div class="bg-white rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-1/2 max-h-screen overflow-y-auto">
                ...
                <div class="p-4">
                    <form id="proveedorForm" method="POST" action="<?php echo e(route('proveedores.store', [], false)); ?>" data-update-base="<?php echo e(url('/proveedores')); ?>">
                        <?php echo csrf_field(); ?>
        ...
        <div id="addFromSolicitudModal"
            ...
            <div class="bg-white rounded-lg shadow-lg w-11/12 md:w-3/4 lg:w-1/2 max-h-screen overflow-y-auto">
                ...
                <div class="p-4">
                    <form id="addFromSolicitudForm" action="<?php echo e(route('productos.store', [], false)); ?>" method="POST"
                            ...
                            <div class="relative mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <div id="solicitud_categoria_dropdown"
                                        class="absolute z-20 w-full bg-white border border-gray-300 rounded-md shadow-lg mt-1 max-h-48 overflow-y-auto hidden">
                                        <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="px-3 py-2 hover:bg-indigo-100 cursor-pointer option-item-cat-solicitud" data-value="<?php echo e($cat); ?>"><?php echo e($cat); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                            ...
                            <div class="relative mb-4">
                                ...
                                <div id="solicitud_proveedor_dropdown"
                                    ...
                                    <div class="px-3 py-2 hover:bg-indigo-100 cursor-pointer option-item-solicitud"
                                        data-id="<?php echo e($proveedor->id); ?>" data-name="<?php echo e($proveedor->prov_name); ?>">
                                        <?php echo e($proveedor->prov_name); ?>
                            ...
                            <div class="relative mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <div id="solicitud_unit_dropdown"
                                        class="absolute z-20 w-full bg-white border border-gray-300 rounded-md shadow-lg mt-1 max-h-48 overflow-y-auto hidden">
                                        <?php $__currentLoopData = $unidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="px-3 py-2 hover:bg-indigo-100 cursor-pointer option-item-cat-solicitud" data-value="<?php echo e($uni); ?>"><?php echo e($uni); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex gap-2 items-center mb-2">
                            ...
                            <select id="manage_prov_moneda" class="hidden">
                                ...
                                ?>
                                <?php $__currentLoopData = $ISO_CURRENCIES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cc); ?>" <?php echo e($cc === 'COP' ? 'selected' : ''); ?>><?php echo e($cc); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<script>
    ...
    const PROV_MAP = (() => {
        try {
            return Object.fromEntries((<?php echo json_encode($proveedores ?? [], 15, 512) ?>).map(p => [String(p.id), {
                id: p.id,
    ...
    function openModal(type) {
        if (type === 'producto') {
            ...
            document.getElementById('productForm').action = "<?php echo e(route('productos.store', [], false)); ?>";
            ...
            if (form) {
                form.reset();
                form.action = "<?php echo e(route('proveedores.store', [], false)); ?>";
  ...
  document.addEventListener('DOMContentLoaded', function(){
        ...
        if (!mProvDrop.innerHTML || !mProvDrop.innerHTML.trim()) {
            mProvDrop.innerHTML = `
                ...
                <?php $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proveedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="px-3 py-2 hover:bg-indigo-100 cursor-pointer manage-option-item" data-id="<?php echo e($proveedor->id); ?>" data-name="<?php echo e($proveedor->prov_name); ?>" data-methods="<?php echo e($proveedor->methods_oc ?? ''); ?>" data-plazo="<?php echo e($proveedor->plazo_oc ?? ''); ?>"><?php echo e($proveedor->prov_name); ?></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            `;
        }
            ...
            if (!cDrop) {
                ...
                cDrop.innerHTML = `
                    <div style="padding:4px 0; max-height: 180px; overflow:auto;">
                        <?php $__currentLoopData = $ISO_CURRENCIES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="px-3 py-2 hover:bg-indigo-100 cursor-pointer currency-item" data-code="<?php echo e($cc); ?>"><?php echo e($cc); ?></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                `;
...
</html><?php /**PATH C:\laragon\www\Requisicion\resources\views/productos/gestor.blade.php ENDPATH**/ ?>