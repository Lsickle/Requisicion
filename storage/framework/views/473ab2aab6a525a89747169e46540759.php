    ...
    <div class="flex-1 px-4 md:px-8 pb-10">
        <div class="max-w-7xl mx-auto bg-white/95 rounded-2xl shadow-2xl p-6 border border-slate-200 ring-1 ring-slate-100">
            <div class="flex items-center justify-between mb-8">
                ...
                <a href="<?php echo e(url()->previous()); ?>" class="px-4 py-2 text-sm rounded-lg border border-slate-300 bg-slate-50 hover:bg-slate-100 shadow-sm transition">Volver</a>
            </div>
            ...
            <div class="overflow-x-auto rounded-xl border border-slate-200 shadow-sm">
                <table class="min-w-full bg-white text-sm" id="tablaProductos">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <?php $__empty_1 = true; $__currentLoopData = ($productos ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        <tr class="hover:bg-indigo-50/40 transition">
                            <td class="px-4 py-3 font-medium text-gray-700"><?php echo e($p->sku ?? $p->id); ?></td>
                            <td class="px-4 py-3 text-gray-800">
                                <div class="font-semibold line-clamp-2 leading-tight"><?php echo e($p->name_produc); ?></div>
                            </td>
                            <td class="px-4 py-3">
                                <span class="px-2.5 py-1 rounded-full text-[11px] font-semibold <?php echo e($catColor); ?> shadow-sm"><?php echo e($cat); ?></span>
                            </td>
                            <td class="px-4 py-3 text-gray-600"><?php echo e($p->unit_produc ?? '-'); ?></td>
                        </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Requisicion\resources\views/productos/lista.blade.php ENDPATH**/ ?>