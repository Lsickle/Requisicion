...
<div class="container mx-auto px-4 py-6 ml-0 md:ml-64">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="mb-4">
                <a href="<?php echo e(route('requisiciones.menu')); ?>" class="text-blue-600 hover:text-blue-800 flex items-center gap-2">
                    ← Volver al menú
                </a>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Requisicion\resources\views/salida_stock/index.blade.php ENDPATH**/ ?>