        ...
        <div class="grid grid-cols-3 gap-4 items-end mb-4">
            <div>
                ...
                <select id="categoriaFilter" class="w-full border rounded-lg p-2">
                    ...
                    <?php $__currentLoopData = $categoriasListaFiltrada; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
