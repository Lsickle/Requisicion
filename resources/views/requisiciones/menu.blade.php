...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid gap-6 menu-grid grid-cols-[repeat(auto-fit,minmax(260px,1fr))] justify-center place-items-center max-w-7xl mx-auto">
            ...
            <!-- Lista de Productos (añadida) -->
            <div class="w-full max-w-sm min-h-[315px] bg-white rounded-xl shadow-lg transition-all duration-300 p-6 border border-gray-200 hover:shadow-2xl hover:scale-105 hover:border-teal-400 flex flex-col justify-between">
                <div class="flex flex-col items-center text-center w-full">
                ...
                <a href="{{ route('productos.lista') }}" class="text-center inline-block bg-teal-500 hover:bg-teal-600 text-white font-medium py-2 px-6 rounded-lg transition-colors duration-200">
                    Ver Lista
                </a>
            </div>
