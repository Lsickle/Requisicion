...
<head>
    <title>Actualización de Estatus - Requisición #{{ $orden_compra->id }}</title>
</head>

<body>
    <h1>Estatus Actualizado - Orden de compra #{{ $orden_compra->id }}</h1>
    ...
    <a href="{{ route('/exportar/ordenes-compra/{id}') }}">Descargar</a>
</body>
