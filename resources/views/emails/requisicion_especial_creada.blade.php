...
<head>
    ...
    <title>Requisición Especial Creada</title>
</head>
<body style="font-family: Arial, Helvetica, sans-serif; background-color:#f5f7fb; padding:24px;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; margin:0 auto; background:#ffffff; border-radius:8px; overflow:hidden;">
        <tr>
            <td style="background:#d97706; padding:16px 24px; color:#ffffff;">
        ...
        <tr>
            <td style="padding:24px; color:#111827;">
                <div style="font-family: Arial, sans-serif; color:#111;">
                    <h2 style="margin:0 0 12px 0;">Requisición Especial Creada</h2>
                    <p style="margin:0 0 12px 0;">Hola {{ $nombreSolicitante ?? 'usuario' }},</p>
                    <p style="margin:0 0 12px 0;">Se ha registrado una nueva requisición especial. Ingresa para realizar su Orden de Compra.</p>
                    ...
                    <p style="margin:16px 0 0 0;">Ingresa para crear la Orden de Compra para esta requisición:</p>
                </div>
            </td>
        </tr>
        <tr>
